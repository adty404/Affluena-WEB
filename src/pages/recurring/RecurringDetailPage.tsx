      ...
      <div className="dashboard-page grid-stack">
        ...
        <section className="form-detail-grid">
          <Card className="panel-card">
            <div className="panel-head"><div><h3>Riwayat Eksekusi</h3><p>Waktu aturan berulang ini terakhir dan berikutnya dijalankan.</p></div><Button to={`/recurring/${rule.id}/history`} size="small"><AppIcon name="history" /> Riwayat Lengkap</Button></div>
            <div className="metric-list">
              <div><span>Terakhir dijalankan</span><strong>{lastRun ?? 'Belum pernah'}</strong></div>
