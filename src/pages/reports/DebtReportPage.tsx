    ...
    <AppLayout title="Laporan Utang" description="Utang, piutang, risiko jatuh tempo, dan penagihan.">
      <div className="dashboard-page grid-stack">
        ...
        <section className="report-filter-bar">
          ...
          <Card className="filter-card"><span>Kategori</span><strong>Utang & piutang</strong></Card>
        ...
        {isLoading ? (
          ...
          <Card className="panel-card"><div className="empty-state"><p>Tidak ada data utang untuk {monthLabel}.</p></div></Card>
        ) : (
          <>
