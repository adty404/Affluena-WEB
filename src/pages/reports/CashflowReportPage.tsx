    ...
    <AppLayout title="Laporan Arus Kas" description="Pergerakan bersih semua dompet per periode.">
      <div className="dashboard-page grid-stack">
        ...
        <section className="report-filter-bar">
          ...
          <Card className="filter-card"><span>Kategori</span><strong>Semua jenis transaksi</strong></Card>
        ...
        {isLoading ? (
          ...
          <Card className="panel-card"><div className="empty-state"><p>Tidak ada data arus kas untuk {monthLabel}.</p></div></Card>
        ) : (
          <>
