    ...
    <AppLayout title="Laporan Target Tabungan" description="Progres target, kesehatan setoran, dan status target bersama.">
      <div className="dashboard-page grid-stack">
        ...
        <section className="report-filter-bar">
          ...
          <div className="report-meta-chip"><span>Kategori</span><strong>Target tabungan</strong></div>
        ...
        {isLoading ? (
          ...
          <Card className="panel-card"><EmptyState icon={<AppIcon name="chart" />} title="Belum ada data laporan" description={`Belum ada data target tabungan untuk ${monthLabel}.`} /></Card>
        ) : (
          <>
