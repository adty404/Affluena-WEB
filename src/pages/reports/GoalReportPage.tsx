...
import { goalReportRows, reportMetrics } from '../../data/mockReporting';
        ...
        <Card className="panel-card">
          ...
          <DataTable<ReportRow>
            ...
            columns={[
              ...
              { key: 'amount', header: 'Current', align: 'right', render: (row) => <Amount value={row.amount} type="income" /> },
