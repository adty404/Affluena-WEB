...
export function BottomNav() {
  ...
  return (
    <nav className="bottom-nav" aria-label="Mobile navigation">
      ...
      <Link to="/transactions/new" className={`bottom-nav-add ${activeClass(pathname === '/transactions/new')}`}><AppIcon name="add" /><span>Add</span></Link>
      <Link to="/transactions" className={activeClass(txActive)}><AppIcon name="transactions" /><span>Transaksi</span></Link>
